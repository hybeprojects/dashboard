    ...
    <div className="container-page p-4">
      ...
      <Card>
        ...
        <div className="mt-3 grid gap-3">
          <Link href="/register/personal" className="block border rounded p-3 text-center">Personal</Link>
          <Link href="/register/business" className="block border rounded p-3 text-center">Business</Link>
        </div>
      </Card>
    </div>
  );
