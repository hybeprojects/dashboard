    ...
    <div className="container-page">
      ...
      <main className="section py-10 max-w-md mx-auto text-center">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          <Link href="/register/personal" className="card-surface p-6 block text-center hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors duration-200 rounded-lg">
          ...
          <Link href="/register/business" className="card-surface p-6 block text-center hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors duration-200 rounded-lg">
