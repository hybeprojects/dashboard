...
export default function Register() {
  const { register, handleSubmit, formState: { errors, isSubmitting } } = useForm<{ firstName: string; lastName: string; email: string; password: string }>({ resolver: yupResolver(registerSchema) });
  ...
  return (
    <div className="container-page">
      ...
      <main className="section py-10">
        ...
        <form className="card-surface p-6 grid gap-4 md:grid-cols-2" onSubmit={handleSubmit(async (v) => { await apiRegister(v); })}>
